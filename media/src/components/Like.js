...
function Like(props) {
    ...
    const likeUnlike = (e) => {
        if(!isLiked) {
            fetch(`http://localhost:8040/api/v1/${scope}/${id}/like`, {
                method: 'POST',
                headers: {
                    'Authorization': token,
                },
            ...
            fetch(`http://localhost:8040/api/v1/${scope}/${id}/unlike`, {
                method: 'POST',
                headers: {
                    'Authorization': token
                }
        ...
        <div className={"like"}>
            ...
            <svg onClick={likeUnlike} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g id="SVGRepo_iconCarrier">
                    ...
                    <path className={isLiked ? 'like-svg unlike-svg' : 'like-svg'} fill-rule="evenodd" clip-rule="evenodd"
